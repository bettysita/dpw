...
<div class="container-fluid row m-0 p-0">
    ...
    <div class="col-md-4 col-sm-6 row m-0 p-0 " style="height: 300px; background-color:red;">
        ...
        <div class="col-md-12" style="height: 100px; background-color :pink;"></div>

    </div>
    <div class="col-md-4 col-sm-6 row m-0 p-0 "style= "height: 300px; background-color:green;">
    <div class="col-md-4 col-xs-12" style="height: 100px; background-color :orange;"></div>
    <div class="col-md-4 col-xs-12" style="height: 100px; background-color :yellow;"></div>
    <div class="col-md-4 col-xs-12" style="height: 100px; background-color :aqua;"></div>
    </div>
